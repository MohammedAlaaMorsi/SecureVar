...
class OriginEnforcementInstrumentedTest {
    ...
    fun allowedOriginWriteSucceeds() {
        ...
        val key = WriteKey.generate(secretKey = "your-app-secret-key-from-backend", scope = "secureName")
        val result = io.mohammedalaamorsi.securevar.WriteKeyValidator.validate(key, androidx.test.core.app.ApplicationProvider.getApplicationContext())
        android.util.Log.e("SECUREVAR_TEST", "ValidationResult: $result")
