package io.mohammedalaamorsi.securevarapp.domain.manager
...
import io.mohammedalaamorsi.securevar.secureVar
 ...
 * This demonstrates the secure variable pattern from the securevar library
 */
class SessionManager(private val userRepository: UserRepository, private val appContext: Context) {
    ...
    fun attemptDirectWrite() {
        ...
        try {
            ...
            isPremiumUser = true // This would trigger: SecureVarManager.trigger("tamper.set", ...)
        } catch (e: Exception) {
