package io.mohammedalaamorsi.securevarapp.data.remote
...
class MockUserApi : UserApi {
    ...
    override suspend fun fetchUserProfile(): UserProfile {
        ...
        val userId = "user-123"
        val nonce = io.mohammedalaamorsi.securevar.WriteKey.generate(
    ...
    companion object {
        ...
        private val keyPair: java.security.KeyPair by lazy {
            ...
            kpg.generateKeyPair().also { kp ->
                ...
                io.mohammedalaamorsi.securevar.WriteKeyValidator.configurePublicKey(pubB64)
            }
        }
