...
object WriteKeyValidator {
    ...
    private fun assessRisk(context: Context): Risk {
        ...
        val highRisk = io.mohammedalaamorsi.securevar.risk.RiskDetector.isHighRisk(context)
    ...
    suspend fun getIntegrityToken(
        ...
        return io.mohammedalaamorsi.securevar.integrity.PlayIntegrityManager.requestIntegrityToken(
            context,
            nonce,
            cloudProjectNumber
        )
